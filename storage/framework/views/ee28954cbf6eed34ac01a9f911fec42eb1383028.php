...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="specialty" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Specialty')); ?></label>

                            <div class="col-md-6">
                                <input id="specialty" type="text" class="form-control <?php $__errorArgs = ['specialty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="specialty" value="<?php echo e(old('specialty')); ?>" required autocomplete="specialty" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\hospital\resources\views/doctor/create.blade.php ENDPATH**/ ?>